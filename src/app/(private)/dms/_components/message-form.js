...
import { MemberInfo, MemberName } from "../../chat2/components/custom-component";
...
export const MessageForm = ({ sx = {} }) => {
    ...
    return (
        <Stack sx={{ ...sx }}>
            ...
            {/* -- MENTION DROPDOWN -- */}
            <Popper open={Boolean(mentionAnchor && filteredUsers.length)} anchorEl={mentionAnchor} placement="top-start" sx={{ zIndex: 9999 }}>
