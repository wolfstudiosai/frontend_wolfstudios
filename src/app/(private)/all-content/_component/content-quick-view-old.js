...
export const ContentQuickViewOld = ({ data }) => {
        ...
        <Box sx={{ position: 'relative' }}>
            ...
            <Stack direction="column" justifyContent="space-between" gap={2} sx={{ p: 2 }}>
                <Stack direction="column" spacing={2}>
                    ...
                    <Stack direction="row" alignItems="center" gap={1}>
                        ...
                        <Box>
                            ...
                            <Stack>
                                <IconWithText icon="solar:calendar-linear" text={dayjs(data?.created_at).format('MMM D, YYYY')} />
                            </Stack>
                        </Box>
                    </Stack>
                ...
                <Stack direction={'row'} gap={2}>
                    <IconWithText icon="hugeicons:instagram" text={data.IG_view} />
                    <IconWithText icon="hugeicons:youtube" text={data.partner_YT_view} />
                    <IconWithText icon="basil:pinterest-outline" text={data.pinterest_view} />
                </Stack>
            </Stack>
        </Box>
    );
