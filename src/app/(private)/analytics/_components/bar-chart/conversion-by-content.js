...
export function ConversionByContent() {

    const data = [
        { name: "Content", conversions: 200 },
        { name: "Partner", conversions: 150 },
        { name: "Levanta", conversions: 100 },
    ];
    return (
                    ...
                    <NoSsr fallback={<Box sx={{ height: 300 }} />}>
                        <ResponsiveContainer width="100%" height={300}>
                            <BarChart data={data} margin={{ top: 20, right: 30, left: 0, bottom: 5 }}>
                                ...
                                <Legend />
                                <Bar dataKey="conversions" fill="#009688" radius={[6, 6, 0, 0]} />
                            </BarChart>
                        </ResponsiveContainer>
                    </NoSsr>
                </CardContent>
