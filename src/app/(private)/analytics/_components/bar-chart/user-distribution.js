...
export function UserDistribution() {
    const data = [
        { name: "Fashion", users: 120 },
        { name: "Tech", users: 90 },
        { name: "Fitness", users: 75 },
        { name: "Travel", users: 60 },
        { name: "Food", users: 80 },
        { name: "Beauty", users: 70 },
    ];
    return (
            ...
            <Card sx={{ width: '100%', borderRadius: 0, border: '1px solid var(--mui-palette-divider)' }}>
                <CardContent>
                    <Typography variant="h6" sx={{ marginBottom: '16px' }}>
                        User Distribution by Partner Category
                    </Typography>
                    <NoSsr fallback={<Box sx={{ height: 300 }} />}>
                        <ResponsiveContainer width="100%" height={300}>
                            <BarChart layout="vertical" data={data} margin={{ top: 20, right: 30, left: 0, bottom: 5 }}>
                                ...
                                <Legend />
                                <Bar dataKey="users" fill="#2196F3" radius={[0, 6, 6, 0]} />
                            </BarChart>
                        </ResponsiveContainer>
                    </NoSsr>
                </CardContent>
