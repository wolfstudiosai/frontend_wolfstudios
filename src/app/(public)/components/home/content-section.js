    ...
    <Stack direction="column" gap={3} sx={{ px: 4, py: 4 }}>
      ...
      <Stack direction="row" gap={2}>
        <Stack
          ...
          sx={{ width: '30%', border: '1px solid', borderColor: 'divider', p: 3 }}
        >
          ...
          <Stack>
            ...
            {['MODEL: KEYBOARD PRO', 'DISPLAY: COLOR OLED DISPLAY', 'AI: MACHINE LEARNING ALGORITHMS'].map(
              (item, index) => (
                <Box
                  key={index}
                  sx={{ borderTop: 1, borderColor: 'divider', py: 1, display: 'flex', justifyContent: 'space-between' }}
                >
        ...
        <Stack sx={{ width: '30%', border: '1px solid', borderColor: 'divider', p: 3 }}>
          ...
          <Stack direction="row" gap={1}>
            ...
            <Stack direction="column" gap={1}>
              ...
              <Box>
                <Button size="small" variant="contained" sx={{ mt: 2, borderRadius: '20px', px: 3 }}>
                  CONTACT US
