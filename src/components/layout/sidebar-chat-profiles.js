...
import { Avatar, Badge, Box, Collapse, List, ListItem, ListItemAvatar, ListItemText, Typography } from '@mui/material';
                  ...
                  >
                    <Box sx={{ position: 'relative' }}>
                      <Avatar
                        ...
                        sx={{ width: isOpen ? 30 : 25, height: isOpen ? 30 : 25, border: '2px solid #fff' }}
                      />
                      <Circle
                        sx={{
                          position: 'absolute',
